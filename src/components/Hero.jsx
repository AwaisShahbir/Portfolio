...
const Hero = () => {
    ...
    return (
        <section id="hero" className="hero-section" style={{ minHeight: isMobile ? 'auto' : '110vh' }}>
            ...
            {/* Particle dots — completely disabled on mobile for performance */}
            {!isMobile && (
            ...
            <motion.div className="container hero-grid" style={{ y: yParallax, opacity: opacityFade }}>
                ...
                >
                    {/* MOBILE PHOTO: static centered capsule with badges below */}
                    <div className="hero-photo-mobile">
                        <div style={{ position: 'relative', width: 'clamp(200px, 60vw, 240px)', height: 'clamp(200px, 60vw, 240px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    {/* DESKTOP PHOTO: Antigravity float with floating absolute badges */}
